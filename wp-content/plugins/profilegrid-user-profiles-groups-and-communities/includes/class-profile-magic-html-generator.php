...
class PM_HTML_Creator
{
	...
	public function get_group_page_fields_html($uid,$gid,$group_leader,$imgsize='',$arg='')
	{
        ...
        <div class="pm-user-card pm-difl pm-border pm-radius5">
          ...
          <div class="pm-user-image pm-dbfl pm-bg-lt <?php echo $class;?>"><?php echo get_avatar($uid,$imgsize,'',false,$profile_args);?></div>
            <div class="pm-user-description pm-dbfl pm-bg-lt">
                <div class="pm-user-card-title pm-dbfl pm-pad10 pm-bg-lt pm-clip">
                <a href="<?php echo esc_url( $profile_url ); ?>"><?php echo $pmrequests->pm_get_display_name($uid,true);?> </a>
                </div>
                  <?php 
			...
			<div class="pm-user-description-row pm-dbfl pm-border">
                            ...
                            switch($field->field_type)
                            {
                                case 'youtube':
                                   ...
                                   ?> 
                                    <div class="pm-card-value pm-difl <?php echo 'pm_collapsable_'.$field->field_type; ?>">
                                        <iframe style="border:<?php if(isset($field_options['video_frame_border'])){ echo $field_options['video_frame_border'].'px solid';} ?>" frameborder="<?php if(isset($field_options['video_frame_border'])){echo $field_options['video_frame_border'];}?>" width="<?php echo ($field_options['video_width']!='')?$field_options['video_width']:640;?>" height="<?php echo ($field_options['video_height']!='')?$field_options['video_height']:360;?>" type="text/html" src="https://www.youtube.com/embed/<?php echo $youtube_id;?>?mute=1&autoplay=<?php echo (isset($field_options['video_auto_play']) && $field_options['video_auto_play']=='1')?'1':'0';?>&fs=<?php echo (isset($field_options['video_fullscreen']) && $field_options['video_fullscreen']=='1')?'1':'0';?>&controls=<?php echo (isset($field_options['video_player_control']) && $field_options['video_player_control']=='1')?'1':'0';?>&loop=<?php echo (isset($field_options['video_loop']) && $field_options['video_loop']=='1')?'1&playlist='.$youtube_id:'0';?>" allowfullscreen allowautoplay></iframe>
                                    </div>
                                    <?php 
                                break;
                                ...
                                case 'mixcloud':
                                   ...
                                   ?> 
                                    <div class="pm-card-value pm-difl <?php echo 'pm_collapsable_'.$field->field_type; ?>">
                                        <iframe style="border:<?php echo $field_options['mixcloud_frame_border'].'px solid'; ?>" width="<?php echo ($field_options['mixcloud_width']!='')?$field_options['mixcloud_width']:640;?>" height="<?php echo ($field_options['mixcloud_height']!='')?$field_options['mixcloud_height']:360;?>" src="https://www.mixcloud.com/widget/iframe/?hide_cover=<?php if(isset($field_options['mixcloud_hide_cover'])){ echo $field_options['mixcloud_hide_cover'];}?>&light=<?php if(isset($field_options['mixcloud_light'])){ echo $field_options['mixcloud_light'];}?>&mini=<?php if(isset($field_options['mixcloud_mini'])){ echo $field_options['mixcloud_mini'];}?>&hide_artwork=<?php if(isset($field_options['mixcloud_hide_artwork'])){ echo $field_options['mixcloud_hide_artwork'];}?>&autoplay=<?php if(isset($field_options['mixcloud_auto_play'])) {echo $field_options['mixcloud_auto_play'];}?>&feed=<?php echo $feed;?>" frameborder="<?php echo $field_options['mixcloud_frame_border'];?>" allow="autoplay"></iframe>
                                    </div>
                                    <?php 
                                break;
        ...
        public function pm_get_user_blogs_shortcode_posts($author,$post_type,$pagenum=1,$limit=10)
        {
            ...
            else
            {
                if(!empty($author))
                {
                    ...
                    {
                        echo "<div class='pg-alert-warning pg-alert-info'> ";
                        _e("There are no user blog posts yet.",'profilegrid-user-profiles-groups-and-communities');
                        echo "</div>";
                    }
                    else
                    {
