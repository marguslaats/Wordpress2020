     ...
     <div class="pm-group-list-view pm-dbfl">
         ...
         <div class="pm-group-name-desc pm-difl">
             ...
             <?php
                ...
                <div class="pm-group-list-view-info"><?php echo $group_type;?> /  <span><?php echo count($group_leaders);?></span> <?php echo $this->pm_get_group_admin_label($group->id);?> / <span><?php echo $this->pm_count_group_members($group->id);?></span> <?php _e('Members','profilegrid-user-profiles-groups-and-communities');?></div>
         </div>
