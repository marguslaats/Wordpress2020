  ...
  <div class="content pm_settings_option">
    ...
    <div class="uimrow"> 
        <a href="admin.php?page=pm_woocommerce_wishlist_extension">
            <div class="pm_setting_image"> 
                <img src="<?php echo $path;?>images/pg-wishlist-woocommerce.png" class="options" alt="options"> 
            </div>
            <div class="pm-setting-heading"> 
                <span class="pm-setting-icon-title"><?php _e( 'WooCommerce Wishlist','profilegrid-user-profiles-groups-and-communities' ); ?></span> 
                <span class="pm-setting-description"><?php _e( 'Define WooCommerce Wishlist integration parameters.','profilegrid-user-profiles-groups-and-communities'); ?></span>
            </div>
         </a> 
    </div>
    <?php } ?>
