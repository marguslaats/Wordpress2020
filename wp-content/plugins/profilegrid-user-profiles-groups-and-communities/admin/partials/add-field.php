    ...
    <form name="pm_add_group" id="pm_add_field" method="post">
        ...
        <div class="content">
           ...
           <!-- <option value="pricing" <?php if (isset($str) && $str == 'pricing') echo 'selected'; ?>><?php _e('Pricing','profilegrid-user-profiles-groups-and-communities'); ?></option> -->
                        ...
                        <option value="mixcloud" <?php if (isset($str) && $str == 'mixcloud') echo 'selected'; ?>><?php _e('MixCloud','profilegrid-user-profiles-groups-and-communities'); ?></option>
                        <option value="soundcloud" <?php if (isset($str) && $str == 'soundcloud') echo 'selected'; ?>><?php _e('SoundCloud','profilegrid-user-profiles-groups-and-communities'); ?></option>
...
<?php _e('Price:','profilegrid-user-profiles-groups-and-communities'); ?>
                ...
                <div class="uimrow" id="video_width_html">
                    <div class="uimfield">
                        <?php _e('Width:','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Set the width of the YouTube video in pixels.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                 <div class="uimrow" id="video_height_html">
                    <div class="uimfield">
                        <?php _e('Height:','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Set the height of the YouTube video in pixels.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow" id="video_frame_border_html">
                    <div class="uimfield">
                        <?php _e('Frame-Border:','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Set the frame-border of the YouTube video in pixels.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow" id="video_auto_play_html">
                    <div class="uimfield">
                        <?php _e('Auto-Play:','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Choose whether the video will auto play or not.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow" id="video_player_control_html">
                    <div class="uimfield">
                        <?php _e('Player Controls:','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Choose whether you want users to have video player controls on the YouTube video.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow" id="video_fullscreen_html">
                    <div class="uimfield">
                        <?php _e('Fullscreen:','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Choose whether the users will have the capability to view the YouTube video in fullscreen mode.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow" id="video_loop_html">
                    <div class="uimfield">
                        <?php _e('Video Loop:','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Choose whether the YouTube video will keep on playing in a loop.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                ...
                <div class="uimrow mixcloud_html" id="mixcloud_width_html">
                    ...
                    <div class="uimnote"><?php _e('Set the width of the MixCloud widget in pixels.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                ...
                <div class="uimrow mixcloud_html" id="mixcloud_height_html">
                    ...
                    <div class="uimnote"><?php _e('Set the height of the MixCloud widget in pixels.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                ...
                <div class="uimrow mixcloud_html" id="mixcloud_frame_border_html">
                    ...
                    <div class="uimnote"><?php _e('Set the frame-border of the MixCloud widget in pixels.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                ...
                <div class="uimrow mixcloud_html" id="mixcloud_auto_play_html">
                    ...
                    <div class="uimnote"><?php _e('Choose whether the audio will auto play or not.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                 <div class="uimrow mixcloud_html" id="mixcloud_hide_cover_html">
                    <div class="uimfield">
                        <?php _e('Hide Cover:','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Choose whether to display cover on the MixCloud widget or not.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow mixcloud_html" id="mixcloud_hide_tracklist_html">
                    <div class="uimfield">
                        <?php _e('Hide Tracklist:','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Choose whether to display tracklist on the MixCloud widget or not.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                 <div class="uimrow mixcloud_html" id="mixcloud_hide_artwork_html">
                    <div class="uimfield">
                        <?php _e('Hide Artwork:','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Choose whether to display artwork on the MixCloud widget or not. Artwork will only be hidden on the Mini Widget.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                 <div class="uimrow mixcloud_html" id="mixcloud_mini_html">
                    <div class="uimfield">
                        <?php _e('Mini:','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Choose whether to display mini version of the MixCloud widget or not.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow mixcloud_html" id="mixcloud_light_html">
                    <div class="uimfield">
                        <?php _e('Light:','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Choose whether to display light version of the MixCloud widget or dark.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_width_html">
                    ...
                    <div class="uimnote"><?php _e('Set the width of the SoundCloud widget in pixels.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_height_html">
                    ...
                    <div class="uimnote"><?php _e('Set the height of the SoundCloud widget in pixels.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_frame_border_html">
                    ...
                    <div class="uimnote"><?php _e('Set the frame-border of the SoundCloud widget in pixels.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                ...
                <div class="uimrow soundcloud_html" id="soundcloud_play_button_color_html">
                    <div class="uimfield">
                        <?php _e('Play Button Color','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Select color for the SoundCloud play button.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow soundcloud_html" id="soundcloud_buy_button_html">
                    <div class="uimfield">
                        <?php _e('Buy Buttons','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Choose whether to show or hide buy buttons.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow soundcloud_html" id="soundcloud_share_button_html">
                    <div class="uimfield">
                        <?php _e('Share Buttons','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Choose whether to show or hide share buttons.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow soundcloud_html" id="soundcloud_download_button_html">
                    <div class="uimfield">
                        <?php _e('Download Buttons','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e('Choose whether to show or hide download buttons.','profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow soundcloud_html" id="soundcloud_show_artwork_html">
                    <div class="uimfield">
                        <?php _e('Show Artwork','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e("Choose whether to show or hide the item's artwork.",'profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow soundcloud_html" id="soundcloud_show_playcount_html">
                    <div class="uimfield">
                        <?php _e('Show Playcount','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e("Choose whether to show or hide the number of track plays.",'profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow soundcloud_html" id="soundcloud_show_user_html">
                    <div class="uimfield">
                        <?php _e('Show User','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e("Choose whether to show or hide the uploader name.",'profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
                
                <div class="uimrow soundcloud_html" id="soundcloud_single_active_html">
                    <div class="uimfield">
                        <?php _e('Single Active','profilegrid-user-profiles-groups-and-communities'); ?>
                    </div>
                    <div class="uiminput">
                    ...
                    <div class="uimnote"><?php _e("Choose whether multiple players on the profile toggle each other off when playing or not.",'profilegrid-user-profiles-groups-and-communities'); ?></div>
                </div>
