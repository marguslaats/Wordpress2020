        ...
        <?php echo $pmrequests->pm_show_profile_image_profile_page($uid, $current_user->ID, $user_info);?>
          ...
          <div class="pm-user-group-name pm-dbfl pm-clip">
              <a href='<?php echo esc_url($group_page_link ); ?>'>
                  ...
                  <span class="pm-user-group-info"><?php echo $groupinfo->group_name;?></span>
              </a>
              ...
              <div class="pg-more-groups"><a onclick="pg_open_group_tab()"><span>+<?php echo count(array_unique($gid))-1 .' '.$group_count_String; ?></span> </a></div>
               <?php endif;?>
      ...
      <!-- header section -->
       ...
       <div class="pg-profile-area-right pm-difl">
          ...
          <div class="pg-additional-header pm-difr">
              ...
              <div class="pg-profile-menu pm-dbfl">   
