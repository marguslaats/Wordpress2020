  ...
  <div class="pm-group-view pm-dbfl">
    <div class="pm-header-section pm-dbfl pm-bg pm-border pm-radius5"> 
      ...
      <div class="pm-profile-title-header pm-dbfl">
        <?php echo $pmrequests->pm_show_profile_image_profile_page($uid, $current_user->ID, $user_info);?>
    ...
    <div class="pm-profile-tabs pm-dbfl" id="pg-profile-tabs">
     <div class="pm-section-nav-horizental pm-dbfl">
       <ul class="mymenu pm-difl pm-profile-tab-wrap pm-border-bt" >	
            ...
            <li class="pm-profile-tab pg-about-tab pm-pad10"><a class="pm-dbfl" href="#pg-about"><?php _e('About','profilegrid-user-profiles-groups-and-communities');?></a></li>
            <li id="pg-profile-groups-tab" class="pm-profile-tab pg-group-tab pm-pad10"><a class="pm-dbfl" href="#pg-groups"><?php _e('Groups','profilegrid-user-profiles-groups-and-communities');?></a></li>
            <?php if($dbhandler->get_global_option_value('pm_enable_blog','1')==1):?>
            <li class="pm-profile-tab pg-blog-tab pm-pad10"><a class="pm-dbfl" href="#pg-blog"><?php _e('Blog','profilegrid-user-profiles-groups-and-communities');?></a></li>
            <?php endif;?>
            ...
            <li class="pm-profile-tab pg-message-tab pm-pad10"><a class="pm-dbfl" href="#pg-messages" onClick="refresh_messenger();"><?php _e('Messages','profilegrid-user-profiles-groups-and-communities');?><b id="unread_thread_count" class=""></b></a></li>
